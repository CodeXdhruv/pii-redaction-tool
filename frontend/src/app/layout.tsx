    ...
    <html lang="en">
      <body>
        <header className="pill-navbar">
          <a href="#" className="logo-icon-only" aria-label="Go to landing page">
            <img src="/maskr-logo.svg" alt="Maskr Logo" width="26" height="26" style={{ borderRadius: '5px' }} />
          </a>
          <nav className="nav-links">
            ...
            >
              <img src="/portfolio.svg" alt="Portfolio" width="18" height="18" />
            </a>
            <a 
